...
function generateBearerToken(apiKey) {
  return request({
    uri: globalSettings.microsoft.endpoint,
    method: 'POST',
    type: 'raw',
    headers: {
...
function microsoft(phrase, voiceName) {
  ...
  return promise.then(() => {
    ...
    return request({
      uri: globalSettings.microsoft.regionendpoint,
      method: 'POST',
      type: 'stream',
      headers: {
...
const VOICE = {
  ...
  HeddaRUS: { language: 'de-DE', gender: 'Female', font: 'Microsoft Server Speech Text to Speech Voice (de-DE, HeddaRUS)' },
  Stefan: { language: 'de-DE', gender: 'Male', font: 'Microsoft Server Speech Text to Speech Voice (de-DE, Stefan, Apollo)' },
  Stefanos: { language: 'el-GR', gender: 'Male', font: 'Microsoft Server Speech Text to Speech Voice (el-GR, Stefanos)' },
  Catherine: { language: 'en-AU', gender: 'Female', font: 'Microsoft Server Speech Text to Speech Voice (en-AU, Catherine)' },
  HayleyRUS: { language: 'en-AU', gender: 'Female', font: 'Microsoft Server Speech Text to Speech Voice (en-AU, HayleyRUS)' },
  Linda: { language: 'en-CA', gender: 'Female', font: 'Microsoft Server Speech Text to Speech Voice (en-CA, Linda)' },
  HeatherRUS: { language: 'en-CA', gender: 'Female', font: 'Microsoft Server Speech Text to Speech Voice (en-CA, HeatherRUS)' },
  Susan: { language: 'en-GB', gender: 'Female', font: 'Microsoft Server Speech Text to Speech Voice (en-GB, Susan, Apollo)' },
  HazelRUS: { language: 'en-GB', gender: 'Female', font: 'Microsoft Server Speech Text to Speech Voice (en-GB, HazelRUS)' },
  George: { language: 'en-GB', gender: 'Male', font: 'Microsoft Server Speech Text to Speech Voice (en-GB, George, Apollo)' },
  Sean: { language: 'en-IE', gender: 'Male', font: 'Microsoft Server Speech Text to Speech Voice (en-IE, Sean)' },
  Heera: { language: 'en-IN', gender: 'Female', font: 'Microsoft Server Speech Text to Speech Voice (en-IN, Heera, Apollo)' },
  PriyaRUS: { language: 'en-IN', gender: 'Female', font: 'Microsoft Server Speech Text to Speech Voice (en-IN, PriyaRUS)' },
  Ravi: { language: 'en-IN', gender: 'Male', font: 'Microsoft Server Speech Text to Speech Voice (en-IN, Ravi, Apollo)' },
  JessaRUS: { language: 'en-US', gender: 'Female', font: 'Microsoft Server Speech Text to Speech Voice (en-US, JessaRUS)' },
  BenjaminRUS: { language: 'en-US', gender: 'Male', font: 'Microsoft Server Speech Text to Speech Voice (en-US, BenjaminRUS)' },
  Jessa24kRUS: { language: 'en-US', gender: 'Female', font: 'Microsoft Server Speech Text to Speech Voice (en-US, Jessa24kRUS)' },
  Guy24kRUS: { language: 'en-US', gender: 'Male', font: 'Microsoft Server Speech Text to Speech Voice (en-US, Guy24kRUS)' },
  GuyNeural: { language: 'en-US', gender: 'Male', font: 'Microsoft Server Speech Text to Speech Voice (en-US, GuyNeural)' },
  AlvinChen: { language: 'en-US', gender: 'Male', font: 'Microsoft Server Speech Text to Speech Voice (en-US, AlvinChen)' },
  Laura: { language: 'es-ES', gender: 'Female', font: 'Microsoft Server Speech Text to Speech Voice (es-ES, Laura, Apollo)' },
  HelenaRUS: { language: 'es-ES', gender: 'Female', font: 'Microsoft Server Speech Text to Speech Voice (es-ES, HelenaRUS)' },
  Pablo: { language: 'es-ES', gender: 'Male', font: 'Microsoft Server Speech Text to Speech Voice (es-ES, Pablo, Apollo)' },
  HildaRUS: { language: 'es-MX', gender: 'Female', font: 'Microsoft Server Speech Text to Speech Voice (es-MX, HildaRUS)' },
  Raul: { language: 'es-MX', gender: 'Male', font: 'Microsoft Server Speech Text to Speech Voice (es-MX, Raul, Apollo)' },
  HeidiRUS: { language: 'fi-FI', gender: 'Female', font: 'Microsoft Server Speech Text to Speech Voice (fi-FI, HeidiRUS)' },
  Caroline: { language: 'fr-CA', gender: 'Female', font: 'Microsoft Server Speech Text to Speech Voice (fr-CA, Caroline)' },
  HarmonieRUS: { language: 'fr-CA', gender: 'Female', font: 'Microsoft Server Speech Text to Speech Voice (fr-CA, HarmonieRUS)' },
  Guillaume: { language: 'fr-CH', gender: 'Male', font: 'Microsoft Server Speech Text to Speech Voice (fr-CH, Guillaume)' },
  Julie: { language: 'fr-FR', gender: 'Female', font: 'Microsoft Server Speech Text to Speech Voice (fr-FR, Julie, Apollo)' },
  HortenseRUS: { language: 'fr-FR', gender: 'Female', font: 'Microsoft Server Speech Text to Speech Voice (fr-FR, HortenseRUS)' },
  Paul: { language: 'fr-FR', gender: 'Male', font: 'Microsoft Server Speech Text to Speech Voice (fr-FR, Paul, Apollo)' },
  Asaf: { language: 'he-IL', gender: 'Male', font: 'Microsoft Server Speech Text to Speech Voice (he-IL, Asaf)' },
  Kalpana: { language: 'hi-IN', gender: 'Female', font: 'Microsoft Server Speech Text to Speech Voice (hi-IN, Kalpana, Apollo)' },
  Kalpana: { language: 'hi-IN', gender: 'Female', font: 'Microsoft Server Speech Text to Speech Voice (hi-IN, Kalpana)' },
  Hemant: { language: 'hi-IN', gender: 'Male', font: 'Microsoft Server Speech Text to Speech Voice (hi-IN, Hemant)' },
  Matej: { language: 'hr-HR', gender: 'Male', font: 'Microsoft Server Speech Text to Speech Voice (hr-HR, Matej)' },
  Szabolcs: { language: 'hu-HU', gender: 'Male', font: 'Microsoft Server Speech Text to Speech Voice (hu-HU, Szabolcs)' },
  Andika: { language: 'id-ID', gender: 'Male', font: 'Microsoft Server Speech Text to Speech Voice (id-ID, Andika)' },
  Cosimo: { language: 'it-IT', gender: 'Male', font: 'Microsoft Server Speech Text to Speech Voice (it-IT, Cosimo, Apollo)' },
  LuciaRUS: { language: 'it-IT', gender: 'Female', font: 'Microsoft Server Speech Text to Speech Voice (it-IT, LuciaRUS)' },
  ...
  HarukaRUS: { language: 'ja-JP', gender: 'Female', font: 'Microsoft Server Speech Text to Speech Voice (ja-JP, HarukaRUS)' },
  HeamiRUS: { language: 'ko-KR', gender: 'Female', font: 'Microsoft Server Speech Text to Speech Voice (ko-KR, HeamiRUS)' },
  Rizwan: { language: 'ms-MY', gender: 'Male', font: 'Microsoft Server Speech Text to Speech Voice (ms-MY, Rizwan)' },
  HuldaRUS: { language: 'nb-NO', gender: 'Female', font: 'Microsoft Server Speech Text to Speech Voice (nb-NO, HuldaRUS)' },
  HannaRUS: { language: 'nl-NL', gender: 'Female', font: 'Microsoft Server Speech Text to Speech Voice (nl-NL, HannaRUS)' },
  PaulinaRUS: { language: 'pl-PL', gender: 'Female', font: 'Microsoft Server Speech Text to Speech Voice (pl-PL, PaulinaRUS)' },
  HeloisaRUS: { language: 'pt-BR', gender: 'Female', font: 'Microsoft Server Speech Text to Speech Voice (pt-BR, HeloisaRUS)' },
  Daniel: { language: 'pt-BR', gender: 'Male', font: 'Microsoft Server Speech Text to Speech Voice (pt-BR, Daniel, Apollo)' },
  HeliaRUS: { language: 'pt-PT', gender: 'Female', font: 'Microsoft Server Speech Text to Speech Voice (pt-PT, HeliaRUS)' },
  ...
  EkaterinaRUS: { language: 'ru-RU', gender: 'Female', font: 'Microsoft Server Speech Text to Speech Voice (ru-RU, EkaterinaRUS)' },
  Filip: { language: 'sk-SK', gender: 'Male', font: 'Microsoft Server Speech Text to Speech Voice (sk-SK, Filip)' },
  Lado: { language: 'sl-SI', gender: 'Male', font: 'Microsoft Server Speech Text to Speech Voice (sl-SI, Lado)' },
  HedvigRUS: { language: 'sv-SE', gender: 'Female', font: 'Microsoft Server Speech Text to Speech Voice (sv-SE, HedvigRUS)' },
  Valluvar: { language: 'ta-IN', gender: 'Male', font: 'Microsoft Server Speech Text to Speech Voice (ta-IN, Valluvar)' },
  Chitra: { language: 'te-IN', gender: 'Female', font: 'Microsoft Server Speech Text to Speech Voice (te-IN, Chitra)' },
  Pattara: { language: 'th-TH', gender: 'Male', font: 'Microsoft Server Speech Text to Speech Voice (th-TH, Pattara)' },
  SedaRUS: { language: 'tr-TR', gender: 'Female', font: 'Microsoft Server Speech Text to Speech Voice (tr-TR, SedaRUS)' },
  An: { language: 'vi-VN', gender: 'Male', font: 'Microsoft Server Speech Text to Speech Voice (vi-VN, An)' },
  ...
  TracyRUS: { language: 'zh-HK', gender: 'Female', font: 'Microsoft Server Speech Text to Speech Voice (zh-HK, TracyRUS)' },
  ...
  HanHanRUS: { language: 'zh-TW', gender: 'Female', font: 'Microsoft Server Speech Text to Speech Voice (zh-TW, HanHanRUS)' },
